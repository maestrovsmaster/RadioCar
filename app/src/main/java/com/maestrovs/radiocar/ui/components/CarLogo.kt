...
import com.maestrovs.radiocar.databinding.ComponentCarLogoBinding

class CarLogo(
    context: Context,
    attributeSet: AttributeSet
) : LinearLayout(context, attributeSet) {
    private var binding: ComponentCarLogoBinding =
        ComponentCarLogoBinding.inflate(LayoutInflater.from(context), this, false)
