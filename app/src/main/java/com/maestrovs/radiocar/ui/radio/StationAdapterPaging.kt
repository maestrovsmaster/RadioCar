...
class StationAdapterPaging(val onItem: ItemListener1) : PagingDataAdapter<Station, StationAdapterPaging.StationViewHolder1>(
    diffCallback) {
    ...
    inner class StationViewHolder1(itemView: View) : RecyclerView.ViewHolder(itemView)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): StationAdapterPaging.StationViewHolder1 {
        return StationViewHolder1(
            LayoutInflater.from(
                parent.context
            ).inflate(
                R.layout.item_radio,
   ...
   // override fun onBindViewHolder(holder: StationAdapter.StationViewHolder, position: Int)
    override fun onBindViewHolder(holder: StationViewHolder1, position: Int) {
